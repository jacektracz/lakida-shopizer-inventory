...
public class CategoryImportManagerByEntityService {

	private static final Logger LOGGER = LoggerFactory.getLogger(CategoryImportManagerByEntityService.class);

	private String langs[] = { "en" };

	public boolean handleRecord(CategoryRequestEntityData entityData, PersistableProduct product, int ii,
