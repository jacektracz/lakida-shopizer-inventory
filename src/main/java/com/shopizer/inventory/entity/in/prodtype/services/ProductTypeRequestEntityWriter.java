...
public class ProductTypeRequestEntityWriter {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(ProductTypeRequestEntityWriter.class);
	...
	public boolean debugRecord(ProductTypesRequestEntityData product,int ii,String outputFile) {
	...
	public boolean writeRecord(ProductTypesRequestEntityData product,int ii,String outputFile) {
	...
	public String getRecordAsJsonString(ProductTypesRequestEntityData product) {
