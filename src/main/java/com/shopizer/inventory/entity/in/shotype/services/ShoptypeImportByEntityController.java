...
public class ShoptypeImportByEntityController {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(ShoptypeImportByEntityController.class);
	
	public boolean sendRecord(ShoptypeRequestEntityData record ,PersistableManufacturer itemToSend,int ii,boolean dryRun,String uri) {
