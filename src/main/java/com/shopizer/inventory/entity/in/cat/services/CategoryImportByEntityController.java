...
public class CategoryImportByEntityController {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(CategoryImportByEntityController.class);
	...
	public boolean sendRecord(CategoryRequestEntityData record ,PersistableCategory product,int ii,boolean dryRun,String uri) {
