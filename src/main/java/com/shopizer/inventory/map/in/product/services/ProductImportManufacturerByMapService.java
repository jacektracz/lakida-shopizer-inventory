...
public class ProductImportManufacturerByMapService {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(ProductImportManufacturerByMapService.class);
	
	
	public boolean handleManufacturer(ProductRequestMapData record, PersistableProduct product, ProductSpecification specs) {
